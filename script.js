...
var ck=’gsheet*’+GOOGLE_SHEET_CSV_URL;var c=scGet(ck);if(c)return Promise.resolve(c);
...
epLabel=’ - Nieuwe aflevering S’+item._epInfo.s+’ E’+item._epInfo.e;
} else if(item._type===‘tv’&&item._season){
epLabel=’ - S’+item._season;
}
return ‘<div class="crow" data-id="'+sid+'"><div class="crow-poster">’+(poster?’<img src=”’+poster+’” alt=”’+title+’” loading=“lazy” onerror=“this.parentElement.innerHTML='<div class=crow-fb>’+title.replace(/’/g,’’).replace(/”/g,’’)+’</div>'”>’:’<div class="crow-fb" id="fb-'+sid+'">’+title+’</div>’)+’</div><div class="crow-info"><div class="crow-title">’+title+’</div><div class="crow-meta">’+tl+epLabel+’ - ‘+sn+’</div></div><div class="crow-badge '+cls+'">’+tl+’</div></div>’;
}
